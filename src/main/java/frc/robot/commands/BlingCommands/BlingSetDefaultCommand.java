...
public class BlingSetDefaultCommand extends CommandBase {
  /**
   * Creates a new BlingSetDefaultCommand.
   */
  ...
  public BlingSetDefaultCommand(BlingSubsystem blingSubsystem) {
