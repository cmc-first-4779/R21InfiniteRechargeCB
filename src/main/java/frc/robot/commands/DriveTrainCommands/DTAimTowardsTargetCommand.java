...
public class DTAimTowardsTargetCommand extends CommandBase {
  /**
  ...
  public DTAimTowardsTargetCommand(DriveTrainSubsystem driveTrainSubsystem, LimelightSubsystem limelightSubsystem, double pipeline, BlingSubsystem blingSubsystem) {
        ...
        kpAim = 0;
        aimMinPower = Constants.LIMELIGHT_SEEK_TURN_DT_POWER;
        aimAndMove = false;
