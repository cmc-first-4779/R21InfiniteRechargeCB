...
public class SeekAndMoveToTargetCommand extends CommandBase {
  ...
  public SeekAndMoveToTargetCommand(DriveTrainSubsystem driveTrainSubsystem, TurretSubsystem turretSubsystem, LimelightSubsystem limelightSubsystem,
